			...
			<div class="container">
				...
				<div class="col-sm-4 header-left">
					<p class="log" id="user_login">
						<a href="ToUserLoginHtmlAction">登录</a> <span>or</span><a
							href="ToUserRegisterHtmlAction">注册</a>
					</p>
					<p class="log">
						<a href="ToSingleBookInfoHtmlAction">图书详情（测试）</a>
					</p>
					<p class="log">
						<a href="ToAdminHtmlAction">管理员（测试）</a>
					</p>
					<p class="log">
					...
					<div class="cart box_1">
						...
						<p>
							<a href="javascript:;" class="simpleCart_empty">书架为空</a>
						</p>
				...
				<div class="col-sm-8 h_menu4">
					<ul class="memenu skyblue">
						<s:iterator var="clist" value="#session.cList">
							<li class="grid"><a href="#"><s:property
										value="#clist.name" /></a>
								<div class="mepanel">
									<div class="row">
										<div class="col1">
				...
				<div class="callbacks_container">
					<ul class="rslides" id="slider">
						<li><img src="images/1.jpg"
							style="width: 90%;height: 55%;border:1px black solid;"></li>
						<li><img src="images/2.jpg" alt=""></li>
						<li><img src="images/1.jpg" alt=""></li>
					</ul>
					<div style="border:1px red solid; margin-top: 2px;">
						<ul class="u1">
							<li class="l1"><img src="images/1.jpg"
